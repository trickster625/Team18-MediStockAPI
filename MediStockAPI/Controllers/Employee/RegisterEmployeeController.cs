...
namespace MediStockAPI.Controllers
{
    public class RegisterEmployeeController : ApiController
    {
        ...
        public IHttpActionResult getEmployees()
        {
            try
            {
                ...
                foreach (var storedEmployee in storedEmployees)
                {
                    ...
                    emp.Employee_SecurityQuestionAnswer = storedEmployees.Employee_SecuirtyQuestionAsnwer;
        ...
        public IHttpActionResult createEmployee(RegisterEmployee newEmployee)
        {
            try
            {
        ...
        public IHttpActionResult updateEmployee(RegisterEmployee updateEmployee)
        {
            try
            {
                RegisterEmployee currentEmployee = new RegisterEmployee();
                ...
                currentEmployee.Employee_SecurityQuestionAnswer = updateEmployee.Employee_SecuirtyQuestionAsnwer;
